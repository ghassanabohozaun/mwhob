...
@section('content')
                            ...
                            <form class="kt-form kt-form--fit mb-15">
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-3 mb-lg-0 mb-6">
                                        <label>{!! trans('videos.search_name') !!}:</label>
                                        <input type="text" class="form-control datatable-input"
                                               name="search_name" id="search_name" autocomplete="off"
                                               placeholder="{!! trans('videos.enter_search_name') !!}">
                                    </div>

                                    <div class="col-lg-6  mb-lg-0 mb-6">
                                        <label>{!! trans('videos.date') !!}:</label>
                                    ...
                                    <div class="col-lg-3  mb-lg-0 mb-6">
                                        <label>{!! trans('videos.status') !!}:</label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            <!--begin: Datatable -->
                                            <table class="table d-table" id="my_videos_data_table">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>@lang('videos.video_image')</th>
                                                    <th>@lang('videos.name_ar')</th>
                                                    <th>@lang('videos.name_en')</th>
                                                    <th>@lang('videos.date')</th>
                                                    <th>@lang('videos.length')</th>
                                                    <th>@lang('videos.views')</th>
    ...
    @include('admin.videos.modals.show_video')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function loadData(search_name = '', status = '', date_from = '', date_to = '') {
            $("#my_videos_data_table").DataTable({
                responsive: !0,
        ...
        //////////////////////////////////////////////////////////////////////////////////////
        // video search btn
        $('body').on('click', '#video_search_btn', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.value) {
                        ...
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                ...
                                Swal.fire({
                                    ...
                                    icon: "warning",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'error_delete_video_button'}
                                });
                                $('.error_delete_video_button').click(function () {
                                });
                            }
                        },//end success
                    });
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_video_button'}
                    })
                }
            });
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            icon: "success",
                            allowOutsideClick: false,
                            customClass: {confirmButton: 'switch_video_status_toggle'}
                        });
                        $('.switch_video_status_toggle').click(function () {
                        });
                    }
                },//end success
            })
