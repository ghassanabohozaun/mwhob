...
@push('js')
    ...
    <script>
        window.data_url = "{!! route('admin.get.trashed.videos') !!}";
        window.columns = [
            {data: "id"},
            {data: "video_image"},
            {data: "name_ar"},
        ...
        $(document).on('click', '.force_delete_video_btn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('admin.force.destroy.video') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            icon: "success",
                            allowOutsideClick: false,
                            customClass: {confirmButton: 'restore_video_button'}
                        });
