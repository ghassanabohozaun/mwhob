...
@section('content')
    ...
    <form class="form" action="{{route('admin.update.sound')}}" method="POST" id="form_sound_update">
    @csrf
    <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($sound->sound_image))}})"></div>
                                                                <label
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        //////////////////////////////////////////////////////
        $("#form_sound_update").on('submit', function (e) {
            e.preventDefault();
            //////////////////////////////////////////////////////////////
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {confirmButton: 'update_sound_button'}
                        });
                        $('.update_sound_button').click(function () {
