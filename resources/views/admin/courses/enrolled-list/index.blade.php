...
@section('content')
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center">
                <a href="#" data-id="{!! $id !!}"
                   class="btn btn-primary btn-sm font-weight-bold font-size-base  mr-1 add_new_course_mawhob">
                    <i class="fa fa-plus-square"></i>
                    {{trans('courses.add_new_mawhob')}}
                </a>
                &nbsp;
            </div>
            <!--end::Toolbar-->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            <!--begin: Datatable -->
                                            <table class="table d-table" id="my_courses_enrolled_mawhob_data_table">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
    ...
    <input type="hidden" value="{!! $id !!}" name="my_course_id" id="my_course_id">
    @include('admin.courses.enrolled-list.modals.add_new_mawhob')
    ...
    <script type="text/javascript">
        ...
        function loadData(search_name = '') {
            ...
            $("#my_courses_enrolled_mawhob_data_table").DataTable({
                ...
                order: [[0, "desc"]],
                ajax: {
                    url: '{!! route('admin.get.courses.enrolled.list') !!}',
                    data: {search_name: search_name, my_course_id: my_course_id},
                },
                columns: [
                    {data: "id"},
                    {data: "mawhob_id"},
        ...
        ///////////////////////////////////////////////////
        /// Delete enrolled mawhob from course
        $(document).on('click', '.delete_mawhob_enrolled_course_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    //////////////////////////////////////
                    $.ajax({
                        url: '{!! route('admin.destroy.mawhob.from.course') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'delete_enrolled_mawhob_from_course_button'}
                                });
                                $('.delete_enrolled_mawhob_from_course_button').click(function () {
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_enrolled_mawhob_fron_course_button'}
                    })
                }
            });
