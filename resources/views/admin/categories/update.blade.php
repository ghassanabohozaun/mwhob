...
@section('content')
    ...
    <form class="form" action="{{route('admin.update.category')}}" method="POST" id="form_category_update">
    @csrf
    <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($category->icon))}})">
                                                                </div>
                                                                <label
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="courses"
                                                                    {!! $category->field ==trans('categories.courses') ? 'selected':'' !!}>
