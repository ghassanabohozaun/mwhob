...
@section('content')
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center">
                <a href="{!! route('admin.trashed.contests') !!}"
                   class="btn btn-light-danger trash_btn" title="{{trans('general.trash')}}">
                    <i class="fa fa-trash"></i>
                </a>
                &nbsp;
                <a href="{!! route('admin.create.contest') !!}"
                   class="btn btn-primary btn-sm font-weight-bold font-size-base  mr-1">
                    <i class="fa fa-plus-square"></i>
                    {{trans('menu.add_new_contest')}}
                </a>
                &nbsp;
            </div>
            <!--end::Toolbar-->
                            ...
                            <form class="kt-form kt-form--fit mb-15">
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6  mb-lg-0 mb-6">
                                        <label>{!! trans('contests.date') !!}:</label>
                                    ...
                                    <div class="col-lg-3  mb-lg-0 mb-6">
                                        <label>{!! trans('contests.status') !!}:</label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            <!--begin: Datatable -->
                                            <table class="table d-table" id="my_contests_data_table">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>@lang('contests.contest_image')</th>
                                                    <th>@lang('contests.name_ar')</th>
                                                    <th>@lang('contests.name_en')</th>
                                                    <th>@lang('contests.short_description_ar')</th>
    ...
    @include('admin.contests.modals.renew-contest')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function loadData(search_name = '', status = '', date_from = '', date_to = '') {
            $("#my_contests_data_table").DataTable({
                responsive: !0,
        ...
        //////////////////////////////////////////////////////////////////////////////////////
        // contest search btn
        $('body').on('click', '#contest_search_btn', function (e) {
            e.preventDefault();
        ...
        //////////////////////////////////////////////////////////////////////////////////////
        // contest reset btn
        $('body').on('click', '#contest_reset_btn', function (e) {
            $('#search_name').val('');
            $('#status').val('');
            $('#date_from').val('');
            $('#date_to').val('');
        ...
        ///////////////////////////////////////////////////
        ///  Contest Delete
        $(document).on('click', '.delete_contest_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('admin.destroy.contest') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'delete_contest_button'}
                                });
                                $('.delete_contest_button').click(function () {
                                ...
                                Swal.fire({
                                    ...
                                    icon: "warning",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'error_delete_contest_button'}
                                });
                                $('.error_delete_contest_button').click(function () {
                                });
                            }
                        },//end success
                    });
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_contest_button'}
                    })
                }
            });
        ...
        $('body').on('change', '.change_status', function (e) {
            ...
            $.ajax({
                url: "{{route('contest.change.status')}}",
