...
@section('content')
    ...
    <form class="form" action="{{route('admin.store.contest')}}" method="POST" id="form_contest_add">
    @csrf
    <!--begin::Subheader-->
...
@push('js')
    <script type="text/javascript">
        ...
        //////////////////////////////////////////////////////
        $('#form_contest_add').on('submit', function (e) {
            e.preventDefault();
            //////////////////////////////////////////////////////////////
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        $('.add_contest_button').click(function () {
