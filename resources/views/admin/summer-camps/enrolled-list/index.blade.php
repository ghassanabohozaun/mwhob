...
@section('content')
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);" class="text-muted">
                            {{trans('SummerCamps.enrolled_list')}}
                        </a>
                    </li>
            ...
            <div class="d-flex align-items-center">
                <a href="#" data-id="{!! $id !!}"
                   class="btn btn-primary btn-sm font-weight-bold font-size-base  mr-1 add_new_summer_camp_mawhob">
                    <i class="fa fa-plus-square"></i>
                    {{trans('summerCamps.add_new_mawhob')}}
                </a>
                &nbsp;
            </div>
            <!--end::Toolbar-->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            <!--begin: Datatable -->
                                            <table class="table d-table" id="my_summer_camp_enrolled_mawhob_data_table">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>@lang('summerCamps.mawhob_id')</th>
                                                    <th>@lang('summerCamps.mawhob_mobile_no')</th>
                                                    <th>@lang('summerCamps.enrolled_date')</th>
    ...
    <input type="hidden" value="{!! $id !!}" name="my_summer_camp_id" id="my_summer_camp_id">
    @include('admin.summer-camps.enrolled-list.modals.add_new_mawhob')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function loadData(search_name = '') {
            var my_summer_camp_id = $('#my_summer_camp_id').val();

            $("#my_summer_camp_enrolled_mawhob_data_table").DataTable({
                ...
                buttons: [
                    {
                        ...
                        text: 'PDF',
                        footer: true,
                        title: "{!! trans('general.summer_camp_enrolled_list') !!}",
                        exportOptions: {
                ...
                order: [[0, "desc"]],
                ajax: {
                    url: '{!! route('admin.get.summer.camp.enrolled.list') !!}',
                    data: {search_name: search_name, my_summer_camp_id: my_summer_camp_id},
                },
                columns: [
                    {data: "id"},
                    {data: "mawhob_id"},
        ...
        ///////////////////////////////////////////////////
        /// Delete enrolled mawhob from summer camp
        $(document).on('click', '.delete_mawhob_enrolled_summer_camp_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    //////////////////////////////////////
                    $.ajax({
                        url: '{!! route('admin.destroy.mawhob.from.summer.camp') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'delete_enrolled_mawhob_from_summer_camp_button'}
                                });
                                $('.delete_enrolled_mawhob_from_summer_camp_button').click(function () {
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_enrolled_mawhob_fron_summer_camp_button'}
                    })
                }
            });
