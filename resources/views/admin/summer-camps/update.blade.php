...
@section('content')
    ...
    <form class="form" action="{{route('admin.update.summer.camp')}}" method="POST" id="form_summer_camp_update">
    @csrf
    <!--begin::Subheader-->
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <label
                                                                    ...
                                                                    <input type="file" name="summer_camp_image"
                                                                           id="summer_camp_image"
                                                            ...
                                                            <span class="form-text text-danger"
                                                                  id="summer_camp_image_error"></span>
                                                        </div>
                                                    </div>
                                                    <!--end::Group-->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{!! $summerCamp->name_ar !!}"
                                                                   class="form-control  form-control-lg"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input value="{!! $summerCamp->name_en !!}"
                                                                   class="form-control  form-control-lg"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      class="form-control  form-control-lg"
                                                                      name="short_description_ar" id="short_description_ar"
                                                                      type="text"
                                                                      placeholder=" {{trans('summerCamps.enter_short_description_ar')}}"
                                                                      autocomplete="off">{!! $summerCamp->short_description_ar !!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      autocomplete="off">{!! $summerCamp->short_description_en !!}</textarea>
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {confirmButton: 'update_summer_camp_button'}
                        });
                        $('.update_summer_camp_button').click(function () {
