...
@section('content')
    ...
    <form class="form" action="{{route('admin.update.story')}}" method="POST" id="form_story_update">
    @csrf
    <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($story->story_icon))}})"
                                                                ></div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                id="kt_story_image">
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset(Storage::url($story->story_image))}})"
                                                                ></div>
                                                                <label
                                                                    class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                                    data-action="change" data-toggle="tooltip" title=""
                                                                ...
                                                                @if($storyCategories && $storyCategories->count()>0)
                                                                    @foreach($storyCategories as $storyCategory)
                                                                        <option value="{!! $storyCategory->id !!}"
                                                                            {{$story->story_category_id == old('story_category_id',$storyCategory->id) ? 'selected': ''}}>
                                                                            @if(Lang()=='ar')
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <select class="form-control kt-select2"
                                                                    ...
                                                                    name="mawhob_id">
                                                                @foreach(App\Models\Mawhob::all() as $mawhob)
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="10"
                                                                      ...
                                                                      autocomplete="off">{!! $story->about_mawhob_ar !!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="10"
                                                                      ...
                                                                      autocomplete="off">{!! $story->about_mawhob_en !!}</textarea>
                                                            ...
                                                            <div class="card ">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="experiences_inputs_container">
                                                                        ...
                                                                        @foreach($mawhobExperiences as $mawhobExperience)
                                                                            <div class="form-group m-form__group row">
                                                                                <div class="col-lg-4">
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           value="{!! $mawhobExperience->experience_name_ar !!}"
                                                                                           autocomplete="off"
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           value="{!! $mawhobExperience->experience_name_en !!}"
                                                                                           autocomplete="off"
                                                                                ...
                                                                                <div class="col-lg-3">
                                                                                    ...
                                                                                    <input type="number"
                                                                                           ...
                                                                                           value="{!! $mawhobExperience->experience_percentage !!}"
                                                                                           autocomplete="off"
...
@push('js')
    <script type="text/javascript">
        ...
        //////////////////////////////////////////////////////
        $('#form_story_update').on('submit', function (e) {
            e.preventDefault();
            //////////////////////////////////////////////////////////////
