...
@section('content')
    ...
    <form class="form" action="{{route('admin.update.program')}}" method="POST" id="form_program_update">
    @csrf
    <!--begin::Subheader-->
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      autocomplete="off">{!! $program->short_description_ar !!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="5"
                                                                      ...
                                                                      autocomplete="off">{!! $program->short_description_en !!}</textarea>
                                                    ...
                                                    @if($program->work_plan == null)
                                                        <div class="form-group row program_work_plane_section">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                                            </label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <span class="label label-danger label-inline label-lg">
                                                                   {{trans('programs.no_work_plane')}}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="form-group row program_work_plane_section">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <span class="label label-dark label-inline label-lg ">
                                                                      <a href="{{Storage::url($program->work_plan) }}"
                                                                         class="text-white"
                                                                         target="_blank">
                                                                    {{trans('programs.show_work_plan')}}
                                                                </a>
                                                                </span>
                                                            </div>
                                                        </div>
...
@push('js')
    <script type="text/javascript">
        ...
        $('#form_program_update').on('submit', function (e) {
            e.preventDefault();
            //////////////////////////////////////////////////////////////
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {confirmButton: 'update_program_button'}
                        });
