                            ...
                            <form class="kt-form kt-form--fit mb-15">
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6  mb-lg-0 mb-6">
                                        <label>{!! trans('programs.date') !!}:</label>
                                    ...
                                    <div class="col-lg-3  mb-lg-0 mb-6">
                                        <label>{!! trans('programs.status') !!}:</label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="dtable scroll">
                                            <!--begin: Datatable -->
                                            <table class="table d-table" id="my_programs_data_table">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>@lang('programs.icon')</th>
...
@push('js')
    ...
    <script src="{{asset('adminBoard/assets/js/ssearch_data_table.js')}}" type="text/javascript"></script>
    ...
    <script>
        ...
        function loadData(search_name = '', status = '', date_from = '', date_to = '') {
            $("#my_programs_data_table").DataTable({
                responsive: !0,
        ...
        //////////////////////////////////////////////////////////////////////////////////////
        // programs search btn
        $('body').on('click', '#programs_search_btn', function (e) {
            e.preventDefault();
        ...
        //////////////////////////////////////////////////////////////////////////////////////
        ///  program Delete
        $(document).on('click', '.delete_program_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('admin.destroy.program') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'delete_program_button'}
                                });
                                $('.delete_program_button').click(function () {
                                ...
                                Swal.fire({
                                    ...
                                    icon: "warning",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'error_delete_program_button'}
                                });
                                $('.error_delete_program_button').click(function () {
                                });
                            }
                        },//end success
                    });
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_program_button'}
                    })
                }
            });
        ...
        $('body').on('change', '.change_status', function (e) {
            ...
            $.ajax({
                url: "{{route('program.change.status')}}",
