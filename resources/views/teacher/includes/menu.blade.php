    ...
    <div style="margin-top:20px"
        ...
        <ul class="menu-nav ">
            ...
            <li class="menu-item  menu-item-submenu"
                ...
                <a href="{!! route('teacher.profile') !!}" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                    ...
                    <span class="menu-text">{{trans('menu.teacher_profile')}}</span>
            ...
            <li class="menu-item  menu-item-submenu"
                aria-haspopup="true" data-menu-toggle="hover">
                <a href="{!! route('teacher.courses') !!}" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                    ...
                    <span class="menu-label">
                        <span class="label label-rounded label-light-success">
                             {{App\Models\Course::withoutTrashed()->where('teacher_id',auth()->guard('teacher')->id())
                                           ->count()}}
                        </span>
                    </span>
                </a>
