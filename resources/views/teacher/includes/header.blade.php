...
<div class="modal fade custom-modal" id="show_teacher_notification_modal" tabindex="-1" role="dialog"
     aria-labelledby="show_teacher_notification_modal"
     aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.show_notification_btn', function (e) {
            ...
            $.get("{!! route('teacher.get.one.notification') !!}", {id, id}, function (data) {
                ...
                $('#show_teacher_notification_modal').modal('show');
