...
<div class="modal fade" id="modal_teacher_show_course_details"
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#cancel_show_course_details', function (e) {
            e.preventDefault();
            $('#modal_teacher_show_course_details').modal('hide');
        });
        ////////////////////////////////////////////////////////////////////////////////////
        ...
        $('body').on('click', '.show_teacher_course_details_btn', function (e) {
            e.preventDefault();
            $.notifyClose();
            var id = $(this).data('id');

            $.ajax({
                url: "{{route('teacher.show.course.details')}}",
                data: {id, id},
                dataType: 'json',
                type: 'GET',
                success: function (data) {
                    ...
                    $('#modal_teacher_show_course_details').modal('show');
                },
