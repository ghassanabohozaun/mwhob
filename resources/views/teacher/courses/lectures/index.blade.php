                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom" id="card_posts">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{route('teacher.store.lecture')}}"
...
@push('js')
    ...
    <script>
        window.data_url = "{!! route('teacher.get.lectures',$id) !!}";
        window.columns = [
            {data: "id"},
            {data: "lecture_date"},
            {data: "lecture_from"},
        ...
        $(document).on('click', '.delete_lecture_btn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('teacher.destroy.lecture') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
        ...
        $('body').on('change', '.change_status', function (e) {
            ...
            $.ajax({
                url: "{{route('teacher.lecture.change.status')}}",
