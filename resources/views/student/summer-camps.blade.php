    ...
    <section class="py-3">
        <div class=" container">
            <div class="row">
                ...
                <div class=" col-lg-9" id="summer_camps_section">
                    <div
                        ...
                        <div class="col-auto title-with-icon d-flex align-items-center px-1">
                            <span class="mr-2">
                                <img src="{!! asset('site/img/icons8-camping-tent-50.png') !!}" width="20">
                            </span>
                    ...
                    @else
                        <div id="summer_camps_data">
                            @include('student.summer-camps-paging')
                        </div>
                    @endif
...
@push('js')
    <script type="text/javascript">
        ...
        function fetch_data(page) {
            $.ajax({
                url: "student/summer-camp/paging?page=" + page,
