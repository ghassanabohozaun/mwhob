    ...
    <div class="left-list-cp">
        ...
        <div class="list-links-pages p-4 bg-light">
            <ul>
                ...
                <li>
                    <a href="{!! route('student.programs') !!}"
                       class="@if(str_contains(url()->current(), 'programs')) active @endif">
                        <span class="icon">
                            <img src="{!! asset('site/img/icons8-sandbox-24.png') !!}" width="30">
                        </span>
                        <span class="title">
                            {!! trans('site.programs') !!}
                        </span>
                ...
                <li>
                    <a href="{!! route('student.summer.camps') !!}"
                       class="@if(str_contains(url()->current(), 'ummer-camps')) active @endif">
                             <span class="icon">
                            <img src="{!! asset('site/img/icons8-camping-tent-50.png') !!}" width="30">
                        </span>
                        <span class="title">
